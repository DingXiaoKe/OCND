...
def test(p):
    ...
    for i in range(0,10):
        ...
        for j in range(0,test_epoch):
            ...
            # directory = 'Test/Mnist/'+str(inlier_class)
            # if not os.path.exists(directory):
            #     os.makedirs(directory)
            # sample = setup(torch.randn(4, z_size))
            # sample = setup(G(sample.view(-1, z_size, 1, 1)))
            # save_image(sample.view(4, 1, 32, 32), 'results/{}/test/sample_{}.png'.format(str(inlier_class), str(epoch)))
        ...
        print(best_f1_score)
            #roc_file_name = os.path.join(path, 'roc_auc_{}.txt'.format(str(percentage)))
            ...
            #    roc_file_name = os.path.join(path, 'best_roc_auc_{}.txt'.format(str(percentage)))
            #    with open(roc_file_name, 'a+') as opt_file:
            #        opt_file.write('---epoch----\n')
            #        opt_file.write('%s' %(str(epoch))+'\n')
            #        opt_file.write('----auc---\n')
            ...
            #prc_file_name = os.path.join(path, 'prc_auc_{}.txt'.format(str(percentage)))
            ...
            #    prc_file_name = os.path.join(path, 'best_prc_auc_{}.txt'.format(str(percentage)))
            #    with open(prc_file_name, 'a+') as opt_file:
            #        opt_file.write('---epoch----\n')
            #        opt_file.write('%s' %(str(epoch))+'\n')
            #        opt_file.write('----prc---\n')
            ...
            #f1_file_name = os.path.join(path, 'f1_score_{}.txt'.format(str(percentage)))
            ...
            #if f1_score > best_f1_score:
            #    best_f1_score = f1_score
            #    f1_file_name = os.path.join(path, 'best_f1_score_{}.txt'.format(str(percentage)))
            #    with open(f1_file_name, 'a+') as opt_file:
            #        opt_file.write('---epoch----\n')
            #        opt_file.write('%s' %(str(epoch))+'\n')
            #        opt_file.write('----f1---\n')
