...
def main():
    ...
    for i in range(10):
        ...
        with open('data/fashion-mnist/fashion-mnist_{}_{}.pkl'.format(str(anomaly_class),'train'), 'rb') as pkl:
        ...
        for epoch in range(train_epoch):
            ...
            for it in range(length):
                ...
                if it % 30 ==0:
                    directory = 'Train/Fashion-MNIST/'+str(anomaly_class)
                    if not os.path.exists(directory):
                        os.makedirs(directory)
                    comparison = torch.cat([x[:4], x_d[:4]])
                    save_image(comparison.cpu(),
                                'Train/Fashion-MNIST/'+str(anomaly_class)+'/reconstruction_'+ str(epoch)+'_'+ str(it) + '.png', nrow=4)
            ...
            model_dir = os.path.join('Model/Fashion-MNIST', str(anomaly_class))
